            ...
            <div class="card border-grey border-lighten-3 m-0">
              ...
              <div class="card-content">
                ...
                <div class="card-body pt-0">
                  <form class="form-horizontal" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>payment/confirm_payment">
                    ...
                    <?php if ($this->session->flashdata('gagal')){ ?>
                      <div class="alert bg-danger alert-icon-left alert-dismissible mb-2" role="alert">
                        ...
                        <strong>Good Morning!</strong> <?php echo $this->session->flashdata('gagal') ?>
                      </div>
                    <?php } ?>
                    <?php if ($this->session->flashdata('success')){ ?>
                      <div class="alert bg-success alert-icon-left alert-dismissible mb-2" role="alert">
                        ...
                        <strong>Good Morning!</strong> <?php echo $this->session->flashdata('success') ?>
                      </div>
                    <?php } ?>
                    <?php echo validation_errors('<div class="alert bg-danger alert-icon-left alert-dismissible mb-2" role="alert">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                          <fieldset class="form-group">
                            <label for="user-email">Bank</label>
                      ...
                      <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                          <fieldset class="form-group">
                            <label for="user-email">Nama Pengirim</label>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 mb-1">
                          <fieldset class="form-group">
                            <label for="user-email">Nominal</label>
                    ...
                    <button type="submit" class="btn btn-danger btn-block"><i class="fa fa-calendar-plus-o"></i> Confirm</button>
                    <a href="<?php echo base_url(); ?>" class="btn btn-danger btn-block"><i class="fa fa-calendar-plus-o"></i> Kembali</a>
