...
<head>
    ...
    <title>Jetz Indonesia | Online Booking</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/app-assets/vendors/css/extensions/unslider.css">
