    								...
    								<form class="form" method="post" action="<?php echo base_url(); ?>admin/users/add">
    									<div class="form-body">
    										...
    										<div class="form-group">
    											...
    											<input type="text" id="donationinput1" class="form-control square" placeholder="Name" name="NAME">
    										</div>
    										...
    										<div class="form-group">
    											...
    											<input type="password" id="donationinput5" class="form-control square" placeholder="Re-Type Password" name="RE-PASSWORD">
    										</div>
